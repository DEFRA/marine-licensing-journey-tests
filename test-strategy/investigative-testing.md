...
### **For Domain Experts (MMO Staff)**

**Day 1: Pick Your First Investigation (15 minutes)**

- Choose a workflow you know well and have seen users struggle with
- Use the simple template above to plan 60-minute session
- Book time when you won't be interrupted

**Day 2-5: Run First Session (60 minutes)**

- Use simple framework: Setup → Explore → Document
- Focus on user experience - what would confuse or frustrate someone?
- Document 2-3 key findings using simple notes template

**Next Week: Share and Plan**

- Brief discussion with team about discoveries
- Identify next area that would benefit from investigation
- Plan regular investigation rhythm

### **For Quality Engineers**

**This Week: Enable Domain Expert Success**

- Review simple framework with MMO staff
- Provide lightweight documentation templates
- Plan collaborative sessions for high-risk areas

**Ongoing: Connect to Automation**

- Use investigation insights to improve automated scenarios
- Track coverage gaps identified through investigation
- Facilitate rather than lead domain expert exploration

### **Making It Sustainable**

- **Start small** - 60-minute sessions are more achievable than longer investigations
- **Build on knowledge** - Leverage what domain experts already understand
- **Focus on value** - Investigate areas where human insight delivers most benefit
- **Keep it collaborative** - Investigation should feel valuable, not burdensome
