# Investigation Examples - Detailed Scenario Scripts

> **🎬 Ready-to-Use Investigation Scenarios**  
> Comprehensive scripts with specific activities, personas, and evidence frameworks.

## 🆕 ML-01: Zofia's Confused First-Timer Investigation

### **Session Charter**

Investigate guidance effectiveness for marine licensing novices
...
Investigate workflow efficiency for experienced marine operators
...
Investigate back-office workflow under realistic operational pressure
...
## 🔧 ML-04: Technical Integration Investigation

### **Session Charter**

Investigate system integration and data flow under realistic conditions

### **Scenario Context**

- **THEME**: Validate cross-system data integration and technical reliability
- **SETUP**: Mixed device usage, various data formats, integration testing
- **PERSONA**: Technical user testing system boundaries and data flow

### **Investigation Focus**

```
EXPLORE: Data integration between systems and platforms
WITH: Various data formats, device switching, connection issues
TO DISCOVER: Integration failures, data corruption, system boundaries
```

### **Realistic Activities**

- Import/export data in different formats
- Test system behaviour during maintenance windows
- Validate data consistency across system boundaries
- Test with various browser configurations
- Simulate network interruptions during data transfer
- Check audit trails and logging accuracy
...
- Audit trails capture all user actions accurately
- System recovery from interruptions works reliably

### **Variations**

- Different browser and device combinations
- Various network conditions and speeds
- Concurrent user access to same data
- System updates during active user sessions
...
- **THEME**: [One-line mission statement]
- **SETUP**: [Realistic conditions and environment]
- **PERSONA**: [User type with specific context and pressures]

### **Investigation Focus**

```
EXPLORE: [Area of application/workflow]
WITH: [Tools, conditions, constraints]
TO DISCOVER: [Types of issues or insights you're seeking]
```

### **Realistic Activities**

- [Activity 1 - realistic user behaviour]
- [Activity 2 - edge case or variation]
- [Activity 3 - environmental factor]
- [Activity 4 - integration or cross-system action]
- [Activity 5 - error recovery or help-seeking]
...
1. **Pick the persona closest to your investigation needs**
2. **Modify activities to match your specific area of focus**
3. **Adjust evidence framework to your quality concerns**
4. **Add variations based on your known risk areas**

### **Creating Your Own Scenarios**

1. **Start with a realistic user story or persona**
2. **Add authentic environmental pressures and constraints**
3. **Include activities that mix normal and edge case behaviour**
4. **Define clear evidence you'll look for during investigation**
5. **Plan variations that test different conditions**
...
_These examples provide structure whilst preserving the flexibility that makes investigative testing valuable. Adapt them to your specific marine licensing context and team needs._
