...
**A.** Confirmed with Tom Mearns that it should remain within the same window
...
- Navigation area on the right side of the service header containing:
  - User name display (e.g. "Tom Mearns")
  - "Defra account" link
