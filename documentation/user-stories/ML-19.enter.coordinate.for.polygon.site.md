...
**AND** the \<point\> in the error message will be replaced with a reference to the point which failed the validation such as "point 3" or "the start and end point"

**EXAMPLE** - "Latitude of point 3 must be a number" or "Enter the longitude of the start and end point"
...
**EXAMPLE** - "Eastings of point 3 must be a number" or "Enter the northings of the start and end point"
