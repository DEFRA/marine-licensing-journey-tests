...
The notification description gives the applicant the opportunity to tell MMO a bit more about their planned activity.

## Resources

- Link to "Notification description" page in prototype MVP
...
**Q.** How much text should we allow in the notification description text field?

**A.** Current MCMS behaviour allows 4000 characters for the "Project Background" field

## Screenshots

**Notification description page showing:**

- "Notification description" as H1 heading
...
- Large textarea field for notification description input
...
### AC1 - Display "Notification description" page

**GIVEN** I am viewing the task list (see [ML-9: View the task list](./ML-9.view.the.task.list.md))

**WHEN** I select the "Notification description" task

**THEN** the "Notification description" page is displayed:
...
### AC2 - Validate the notification description

**GIVEN** I am viewing the "Notification description" page

**WHEN** I select the "Save and continue" button

**THEN** the following validation will be performed:

- **Mandatory field** - if I have not provided any text, display the following error: "Enter the notification description"
- **Maximum length of text** - if I have provided text which is greater than 4000 characters, display the following error: "Notification description must be 4000 characters or less"

### AC3 - Save the notification description
...
**THEN** the notification description will be saved  
**AND** I will be returned to the task list  
**AND** the "Notification description" task will be marked as "Completed"
