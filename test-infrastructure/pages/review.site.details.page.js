...
export default class ReviewSiteDetailsPage extends CommonElementsPage {
  ...
  static getSiteName(siteNumber) {
    return `//h2[contains(text(), "Site ${siteNumber} details")]/..//dt[contains(normalize-space(text()), "Site name")]/following-sibling::dd`
  }

  static getSiteActivityDates(siteNumber) {
    return `//h2[contains(text(), "Site ${siteNumber} details")]/..//dt[contains(normalize-space(text()), "Activity dates")]/following-sibling::dd`
  }

  static getSiteActivityDescription(siteNumber) {
    return `//h2[contains(text(), "Site ${siteNumber} details")]/..//dt[contains(normalize-space(text()), "Activity description")]/following-sibling::dd`
  }
