...
Feature: Public Register Consent
  ...
  Scenario: Can provide a reason for withholding information from the public register
    Given the Public register page is displayed
    When choosing to withhold information from the public register by selecting “Yes”
    Then the option to provide a reason for withholding information is available
