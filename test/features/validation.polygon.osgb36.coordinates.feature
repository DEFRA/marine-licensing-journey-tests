...
Feature: Validation of polygon coordinates: preventing entry of invalid coordinate values for polygon sites using OSGB36 coordinates
  ...
  Scenario: Error when no OSGB36 coordinates are entered for polygon
    ...
    Then the following validation errors are displayed:
      | Field                         | Error Message                                  |
      | Start and end point eastings  | Enter the eastings of the start and end point  |
      | Start and end point northings | Enter the northings of the start and end point |
  ...
  Scenario Outline: Error when OSGB36 coordinate field contains invalid data for field type <fieldType> for point <point> with value <invalidValue>
    ...
    Examples:
      ...
      | Eastings  | Start and end point | abc123       | Eastings of the start and end point must be a number                                     |
      | Eastings  | Point 2             | def456       | Eastings of point 2 must be a number                                                     |
      | Eastings  | Point 3             | ghi789       | Eastings of point 3 must be a number                                                     |
      | Northings | Start and end point | xyz123       | Northings of the start and end point must be a number                                    |
      ...
      | Eastings  | Start and end point |      -123456 | Eastings of the start and end point must be a positive 6-digit number, like 123456       |
      ...
      | Northings | Start and end point |      -123456 | Northings of the start and end point must be a positive 6 or 7-digit number, like 123456 |
      ...
      | Eastings  | Start and end point |        12345 | Eastings of the start and end point must be 6 digits                                     |
      | Eastings  | Point 2             |          123 | Eastings of point 2 must be 6 digits                                                     |
      | Eastings  | Point 3             |         1234 | Eastings of point 3 must be 6 digits                                                     |
      | Northings | Start and end point |        12345 | Northings of the start and end point must be 6 or 7 digits                               |
      ...
      | Eastings  | Start and end point |      1234567 | Eastings of the start and end point must be 6 digits                                     |
      ...
      | Northings | Start and end point |     12345678 | Northings of the start and end point must be 6 or 7 digits                               |
